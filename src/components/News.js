...
export class News extends Component {
  ...
  async componentDidMount(){
    ...
    let url=`https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=7cceb152b90f4af98b415c5a3334a10a&page=1&pageSize=${this.props.pageSize}`; //api url
  ...
  handlePrevClick = async ()=>{
    ...
    let url=`https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=7cceb152b90f4af98b415c5a3334a10a&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
